...
Version  : 2020.4
Release  : 32
URL      : https://cran.r-project.org/src/contrib/SQUAREM_2020.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/SQUAREM_2020.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598642139
