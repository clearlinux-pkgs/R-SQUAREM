...
Version  : 2020.1
Release  : 25
URL      : https://cran.r-project.org/src/contrib/SQUAREM_2020.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/SQUAREM_2020.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578969185
